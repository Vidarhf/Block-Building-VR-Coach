...
public class SpeechManager : MonoBehaviour {
    ...
    public Controller startRecoController;
    ...
    void Start () {
        ...
        //startRecoButton.onClick.AddListener(StartRecordVoice);
        tmpMessage = message;
    }
    ...
    void Update()
    {
        ...
        if(OVRInput.Get(OVRInput.Button.One, startRecoController) && !waitingForReco){
            print("OVRINPUT:" + "Button pressed");
            StartCoroutine("StartRecordVoice");
            //StartRecordVoice();
        }
        else if (OVRInput.Get(OVRInput.Button.Two, startRecoController)){
    ...
    public async void StartRecordVoice()
    {
        // Creates an instance of a speech config with specified subscription key and service region.
        // Replace with your own subscription key and service region (e.g., "westus").
        var config = SpeechConfig.FromSubscription("403c8df4b77441b4be4e9c9228890a10", "northeurope");
    ...
    private void sendVoiceMessage(string msg)
    {
        networkManager.SendVoiceMessageToRasa(msg);
    }
    /// <summary>
